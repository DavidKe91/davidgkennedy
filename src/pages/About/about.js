                                ...
                                <div className="row">
                                    <div className="col-12">
                                        <div className="aboutMeRow">
                                            <p className="mb-4">My name is David Kennedy and I am a Frontend Developer based in Meath. Having initially worked as a graphic designer, I later transitioned to Frontend web development and I am now looking for me next opportunity.</p>
